...
**Operational requirements:** Someone must purchase and supply codes in advance. Codes are finite — when stock runs out, the reward disappears from the catalogue until replenished. A replenishment cadence needs to be agreed with the partner from the outset.

**Fulfilment:** Fully automated once codes are loaded. Youth receive the code immediately on redemption; no action required from the partner or your team.
...
**Operational requirements:** Lower barrier to get partners live — no codes to procure. The partner simply needs to confirm how many places are available and how they'll manage attendees. A clear fulfilment process must be agreed before the reward goes live.

**Fulfilment:** Not automated. The partner (or your team) is responsible for confirming the RSVP and delivering the experience. Build this into your partner onboarding conversation.

> ⚠️ **Important:** Because fulfilment is manual, non-contract rewards can create support overhead if the process isn't clear. Make sure youth know what to expect after redemption — and make sure the partner knows what they're committing to.
...
**Operational requirements:** Requires an upfront monetary commitment from the implementing organisation or a funder. The Chimoney integration handles the actual transfer.

**Status:** Planned for 2026. If this model is important to your deployment, track updates via [Roadmap Features](../07-reference/07-04-roadmap-features.md).

## Choosing the Right Model

Most deployments use a mix of all three — or at least the first two. A useful starting framework:

| If your goal is…                                             | Lead with…                                               |
| ------------------------------------------------------------ | -------------------------------------------------------- |
| Fast launch with minimal partner complexity                  | Non-contract rewards — low setup friction                |
| Maximum youth appeal and high redemption rates               | Voucher code rewards — immediate, tangible value         |
| Broad market coverage without specific partners              | A SureGifts-style voucher marketplace (Model 1 at scale) |
