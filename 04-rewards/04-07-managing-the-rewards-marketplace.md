# Managing the Rewards Marketplace

*Last updated: February 2026*

Getting rewards live is the beginning, not the end. A rewards marketplace that isn't actively managed quickly develops gaps — depleted stock, stale listings, rewards that no longer resonate. This article covers the ongoing management responsibilities that keep the demand side of your ecosystem working.

## What You're Managing

Your day-to-day management responsibilities fall into four areas:

- **Stock monitoring** — tracking voucher code inventory and triggering replenishment before stock runs out.
- **Catalogue health** — retiring rewards that have expired, adding new ones to maintain variety.
- **Redemption data** — reviewing what's being redeemed, what isn't, and what that tells you.
- **Partner relationships** — maintaining the connections that keep the catalogue supplied and growing.

None of this is technically complex. The challenge is doing it consistently, especially as your deployment scales and the number of active rewards grows.

## Stock Monitoring and Replenishment

For voucher code rewards, stock is finite. When codes run out, the reward disappears from the marketplace until new codes are loaded. Youth who were working toward a reward they can no longer see — or who try to redeem and find it unavailable — will be frustrated. Manage stock proactively, not reactively.
...
A stale rewards catalogue is a quiet killer of youth engagement. Youth who visit the marketplace and see the same listings they've already redeemed — or the same listings they can't yet afford — stop visiting. Freshness signals that the programme is alive and worth checking back on.
...
Partner renewals are part of this rhythm too. Voucher code relationships benefit from periodic check-ins — making sure the partner is still willing to supply codes, updating them on redemption numbers (which are positive news for them), and exploring whether they'd like to offer additional products or increased stock.

## Minimum Viable Ongoing Effort

For a pilot-scale deployment, the core management tasks per month are roughly:
